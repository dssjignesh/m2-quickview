                        ...
                        $(document).on(
                            ...
                            function (e) {
                                ...
                                if ($(this).attr('data-post')) {
                                    ...
                                    url = data_url.action + 'product/' + data_url.data.product + '/qty/' + qty + '/form_key/' + from_key + '/uenc/' + data_url.data.uenc + '/dssquickview/1';
                                } else {
                                    url = $(this).attr('href');
